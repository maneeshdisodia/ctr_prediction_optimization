...
with open('temp', 'wb') as outcsv:
    for y in range(x2array.shape[0]):
        ...
        if 1 in x2array[y]:
            ...
            print count
            outcsv.write(
                "1 1.0 'A_B_C_D| %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s \n" % (
            ...
            outcsv.write(
                "-1 1.0 'A_B_C_D| %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s \n" % (
                    ...
                    x2array[y][18], x2array[y][19], x2array[y][20], x2array[y][21], x2array[y][22], x2array[y][23],
                    x2array[y][24], x2array[y][25], x2array[y][26], x2array[y][27], x2array[y][28], x2array[y][29],
                    x2array[y][30], x2array[y][31]))  # input_path = "temp"
...
os.system("vw xaa -l 10 --loss_function=logistic --link=logistic  -c -f vw_temp.model && vw -i vw_temp.model -t xab -p  /dev/stdout --quiet >> feed_prediction && awk '!seen[$0]++' feed_prediction >> ad_unit_prediction && echo Verified_and_executed|| echo commmand Down")
